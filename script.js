...
function setupTechniqueForm() {
    ...
    form.addEventListener("submit", async function(event) {
        ...
        const keys = document.getElementById("newKeys").value.trim();
        const principle = document.getElementById("newPrinciple").value.trim();
        const use = document.getElementById("newUse").value.trim();
        ...
        const container = document.getElementById("techniqueCards");
        const card = document.createElement("a");
        card.className = "card " + difficulty.toLowerCase();
        card.href = "detail.html?technique=" + id;
